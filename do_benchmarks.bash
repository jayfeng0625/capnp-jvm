...
alias run_java="java -cp capnp-jvm-core/target/classes:capnp-jvm-serialization/target/classes:capnp-jvm-serialization-bytebuffer/target/classes:benchmark/target/classes"
